...
class MainWindow ( wx.Frame ):
    ...
    def __init__( self, parent ):
        wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = _(u"sptk"), pos = wx.DefaultPosition, size = wx.Size( 745,412 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )

        self.SetSizeHints( wx.DefaultSize, wx.DefaultSize )

        self.menubar = wx.MenuBar( 0 )
        self.mnu_file = wx.Menu()
        self.mnu_send = wx.MenuItem( self.mnu_file, wx.ID_ANY, _(u"Send"), wx.EmptyString, wx.ITEM_NORMAL )
        ...
        self.mnu_ser_port = wx.MenuItem( self.mnu_settings, wx.ID_ANY, _(u"Serial port"), wx.EmptyString, wx.ITEM_NORMAL )
        self.mnu_settings.Append( self.mnu_ser_port )

        self.menubar.Append( self.mnu_settings, _(u"Settings") )

        self.mnu_help = wx.Menu()
        self.mnu_about = wx.MenuItem( self.mnu_help, wx.ID_ANY, _(u"About")+ u"\t" + u"F1", wx.EmptyString, wx.ITEM_NORMAL )
        self.mnu_help.Append( self.mnu_about )

        self.menubar.Append( self.mnu_help, _(u"Help") )

        self.SetMenuBar( self.menubar )

        self.toolbar = self.CreateToolBar( wx.TB_HORIZONTAL, wx.ID_ANY )
        self.tool_open_port = self.toolbar.AddTool( wx.ID_ANY, _(u"tool"), wx.ArtProvider.GetBitmap( wx.ART_FILE_OPEN,  ), wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None )

        self.tool_close_port = self.toolbar.AddTool( wx.ID_ANY, _(u"tool"), wx.ArtProvider.GetBitmap( wx.ART_CLOSE,  ), wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None )
        ...
        self.btn_tx_clear = wx.Button( self.left_panel, wx.ID_ANY, _(u"Clear"), wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.btn_rx_clear = wx.Button( self.right_panel, wx.ID_ANY, _(u"Clear"), wx.DefaultPosition, wx.DefaultSize, 0 )
...
class SerialPortDialog ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = _(u"Serial port"), pos = wx.DefaultPosition, size = wx.Size( 312,306 ), style = wx.DEFAULT_DIALOG_STYLE )
        ...
        self.lbl_port = wx.StaticText( self, wx.ID_ANY, _(u"Port:"), wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.lbl_baud = wx.StaticText( self, wx.ID_ANY, _(u"Baudrate:"), wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.lbl_data = wx.StaticText( self, wx.ID_ANY, _(u"Data:"), wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.lbl_parity = wx.StaticText( self, wx.ID_ANY, _(u"Parity:"), wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.lbl_stop = wx.StaticText( self, wx.ID_ANY, _(u"Stop bits:"), wx.DefaultPosition, wx.DefaultSize, 0 )
...
class SendDialog ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = _(u"Send"), pos = wx.DefaultPosition, size = wx.Size( 567,226 ), style = wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER )
        ...
        self.btn_send = wx.Button( self, wx.ID_ANY, _(u"Send"), wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.check_hex = wx.CheckBox( self, wx.ID_ANY, _(u"Hex data"), wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.btn_close = wx.Button( self, wx.ID_ANY, _(u"Close"), wx.DefaultPosition, wx.DefaultSize, 0 )
